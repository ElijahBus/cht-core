...
@test "couchdb1 node is available" {
	...
	run curl -s -u "$COUCHDB_USER:$COUCHDB_PASSWORD" "http://couchdb.1:5984/_up"
...
@test "couchdb2 node is available" {
	...
	run curl -s -u "$COUCHDB_USER:$COUCHDB_PASSWORD" "http://couchdb.2:5984/_up"
...
@test "couchdb3 node is available" {
	...
	run curl -s -u "$COUCHDB_USER:$COUCHDB_PASSWORD" "http://couchdb.3:5984/_up"
